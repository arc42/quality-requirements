...
== Einführung: Kategorien von Qualitätsanforderungen


:numbered!:
== Über Qualität
Die Qualität eines Produktes oder Systems ist ganz allgemein als die Summe seiner Eigenschaften definiert.

In der Praxis haben sich einige Kategorien (Oberbegriffe) für häufig auftretende _Qualitätsanforderungen_ 
(synonym: Qualitätsziele) etabliert, im wesentlichen durch das DIN/ISO 9126 Begriffsmodell geprägt.
...
nicht finden, so schauen Sie bitte im Anhang: <<qmerkmale, Q-Merkmale>> - dort finden
Sie eine umfangreiche Tabelle der Q-Merkmale mit ihren Synonymen und
Oberbegriffen.


IMPORTANT: Der Anhang selbst fehlt noch
...
Qualitätsmerkmalen stammen teilweise aus DIN/ISO 9126 bzw. dem FURPS-Modell+.
